...
import sivl.platform.pay.sdk.chinapay.wap.ChinaWapUtil;
import sivl.platform.pay.service.PaymentService;

@Service("chinapayWapService")
public class ChinapayWapServiceImpl implements PaymentService {
	...
	public ResultModel<Object> payment(Map<String, Object> params) {
		...
		if (result.getCode().equals(ResultCons.SUCCESS)) {
			// 调起支付支付
			result = ChinaWapUtil.payment(payment);
		}
		return result;
	}
