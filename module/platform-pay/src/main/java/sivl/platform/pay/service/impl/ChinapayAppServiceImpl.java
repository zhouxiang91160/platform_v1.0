...
import sivl.platform.pay.sdk.chinapay.app.ChinaAppUtil;
import sivl.platform.pay.service.PaymentService;

@Service("chinapayAppService")
public class ChinapayAppServiceImpl implements PaymentService {
	...
	public ResultModel<Object> payment(Map<String, Object> params) {
		...
		if (result.getCode().equals(ResultCons.SUCCESS)) {
			// 调起支付支付
			result = ChinaAppUtil.payment(payment);
		}
		return result;
	}
